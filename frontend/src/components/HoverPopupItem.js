...
const HoverPopupItem = ({product,name,image,price,qty}) => {
            ...
            <Row className='py-2 border-bottom border-top'>
                <Col xs={7} className='ml-3 px-0'>
                    ...
                    <Col className='my-auto pl-0 pr-1 text-right' xs={3}>
                            <FiTrash2 className='shadow-sm my-auto' size='1.2em' onClick={() =>removeFromCartHandler(product) }/>
                    ...
                    <Row className='mt-2 mx-0'>
                        ...
                        <Col  className='my-auto pr-0'>
                            <h6 className='text-left my-auto'>x {qty} = {round(price * qty)} Dh</h6>
                        </Col>
                    </Row>
                </Col>

                <Col className='ml-0 pl-0 my-auto' xs={4}>
                    <Image className='text-left ml-0 pl-0' style={{height: '5em', width: '5em'}} src={image} rounded/>
                </Col>
